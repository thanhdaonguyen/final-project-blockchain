...
export async function isCorrectHash(
    ...
    try {
        const hashHex = await getHash(fileData);
...
export async function getHash(fileData: string): Promise<string | null> {
    try {
...
export async function verifySignature(
    ...
    try {
        const convertedPublicKey = await importKeyFromString(publicKey, [
            "verify",
        ]);
